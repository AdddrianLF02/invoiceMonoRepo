...
describe('Money', () => {
  ...
  describe('add', () => {
    it('should add two Money objects', () => {
      const money1 = Money.fromFloat(10.99);
      const money2 = Money.fromFloat(20.01);
    ...
    it('should throw an error when adding different currencies', () => {
      ...
      const money2 = Object.create(Money.fromFloat(20.01));
  ...
  describe('multiply', () => {
    ...
    it('should multiply by a decimal factor', () => {
      const money = Money.fromFloat(100);
  ...
  describe('equals', () => {
    it('should return true for equal Money objects', () => {
      const money1 = Money.fromFloat(10.99);
      const money2 = Money.fromFloat(10.99);
      expect(money1.equals(money2)).toBe(true);
    });

    it('should return false for different amounts', () => {
      const money1 = Money.fromFloat(10.99);
      const money2 = Money.fromFloat(10.98);
