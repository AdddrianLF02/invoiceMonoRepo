...
declare function validate(value: unknown, schemaOrDto: ZodSchema | ZodDto, createValidationException?: ZodExceptionCreator): any;

export { UseZodGuard, ZodDto, ZodGuard, ZodValidationException, ZodValidationPipe, createZodDto, createZodGuard, createZodValidationPipe, patchNestJsSwagger, validate, zodToOpenAPI };
