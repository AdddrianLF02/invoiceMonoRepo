...
export const UserEntitySchema = z.object({
  id: z.string().cuid('El ID de usuario debe ser un CUID válido'),
...
export class User {
  ...
  private constructor(props: UserData) {
    this.id = UserId.fromString(props.id as string);
    this.name = (props.name as string) ?? null;
    this.email = Email.create(props.email as string);
